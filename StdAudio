...
/**
 * ***********************************************************************
 * A simple library for reading, writing, and manipulating .wav files and
 * playing raw audio data.
 *
 * Limitations: - Does not seem to work properly when reading .wav files from a
 * .jar file. - Assumes the audio is monaural, with sampling rate of 44,100.
 ************************************************************************
 */
import java.applet.*;
import java.io.*;
...
public final class StdAudio {
    ...
    public static class AudioEvent {
        ...
        public static enum Type {
            PLAY, LOOP, PAUSE, UNPAUSE, STOP, MUTE, UNMUTE
        }
    ...
    /**
     * Removes all audio event listeners from being notified of future audio
     * events, if any were present. If none were present, has no effect.
     */
    ...
    /**
     * Sets whether the audio system is muted. If audio is muted, notes do not
     * play and playing methods return immediately.
     */
    ...
    /**
     * Sets whether the audio system is paused. If audio is paused, playing
     * methods "block" in an infinite while loop.
     */
